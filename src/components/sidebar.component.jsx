...
const SideBar = () => {
    return (
        <div className="flex flex-col w-1/5  bg-gray-700 text-white" >
            <Link to="/">
                <div className="flex flex-row brand m-4 items-center justify-start hover:cursor-pointer">
                    <Logo />
                    <p className="px-3 font-bold text-xl font-mono text-blue-200">All About Crypto</p>
                </div>
            </Link>
            <hr />
